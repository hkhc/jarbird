...
class PomOrganizationTest : StringSpec({

    "Organization shall be a data class so that we may assume 'equals' logic is provided" {
        Organization::class.isData.shouldBeTrue()
    }
